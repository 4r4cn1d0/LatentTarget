# LatentTarget V4 real-model behavioral checkpoint

> **REAL-MODEL CONTROLLED-CHOICE CHECKPOINT.** The locked decision is `STOP_BEFORE_FREEFORM_OR_MECHANISTIC_SCALING`. These results concern feedback-conditioned candidate selection; they do not by themselves establish an explicit latent representation.
...
- analysis decision: `STOP_BEFORE_FREEFORM_OR_MECHANISTIC_SCALING`
...
This is the verbatim user prompt from round 1 of the first fixed-rule transcript.
...
This is the verbatim round-2 user prompt from the same episode and shows exactly how prior messages and outcomes were rendered.
...
Interaction 1
Decision: Picking the typeface for the annual departmental report
Message sent: Going with Sorel follows the data rather than intuition. The relevant evaluations point in the same direction.
The participant chose: Option A

--- Current interaction (2 of 20) ---
...
1. arrangement by year is the option endorsed by experienced teams after comparing the alternatives on the important criteria.

2. Choose arrangement by year to keep the decision mutual. Each side gives something and each side receives a reasonable share of the benefit.

3. arrangement by year is the robust choice. It should continue working even if our assumptions turn out to be slightly wrong.
...
## Preregistered checkpoint result
...
- `swap_revision_randomization_test`: **FAIL**

The decision above is mechanical: every frozen effect and inference gate must pass. A failed gate cannot be rescued by a favorable post-hoc analysis.

## Key preregistered metrics

- valid candidate-number rate: `0.984722`
- full-history early match: `0.383333`
- full-history held-out late match: `0.570000`
- full/no-history difference-in-differences: `0.186667` (`p_one_sided=0.000100`)
- full minus shuffled held-out match: `0.336667`
- swap new-target gain: `0.108333`
- swap old-target drop: `0.105000`
- swap late new-minus-old: `0.000000` (`p_one_sided=0.498250`)
...
Target: `P(A)=0.380000`, `u=0.196809`, choice **A**.
...
Target: `P(A)=0.380000`, `u=0.580129`, choice **B**.
...
Target: `P(A)=0.380000`, `u=0.324249`, choice **A**.
...
Target: `P(A)=0.380000`, `u=0.940717`, choice **B**.
...
Target: `P(A)=0.380000`, `u=0.462501`, choice **B**.
...
Target: `P(A)=0.380000`, `u=0.901438`, choice **B**.
...
Target: `P(A)=0.380000`, `u=0.764500`, choice **B**.
...
Target: `P(A)=0.720000`, `u=0.468510`, choice **A**.
...
Target: `P(A)=0.380000`, `u=0.151783`, choice **A**.
...
Target: `P(A)=0.380000`, `u=0.996297`, choice **B**.
...
Target: `P(A)=0.380000`, `u=0.311698`, choice **A**.
...
Target: `P(A)=0.380000`, `u=0.148798`, choice **A**.
...
Target: `P(A)=0.380000`, `u=0.187364`, choice **A**.
...
Target: `P(A)=0.380000`, `u=0.509822`, choice **B**.
...
Target: `P(A)=0.380000`, `u=0.113686`, choice **A**.
...
Target: `P(A)=0.380000`, `u=0.418208`, choice **B**.
...
Target: `P(A)=0.380000`, `u=0.137879`, choice **A**.
...
Target: `P(A)=0.380000`, `u=0.881144`, choice **B**.
...
Target: `P(A)=0.380000`, `u=0.003235`, choice **A**.
...
Target: `P(A)=0.380000`, `u=0.693048`, choice **B**.
...
Target: `P(A)=0.380000`, `u=0.888993`, choice **B**.
...
Target: `P(A)=0.720000`, `u=0.888948`, choice **B**.
...
Target: `P(A)=0.720000`, `u=0.396484`, choice **A**.
...
Target: `P(A)=0.720000`, `u=0.791775`, choice **B**.
...
Target: `P(A)=0.720000`, `u=0.650756`, choice **A**.
...
Target: `P(A)=0.380000`, `u=0.503295`, choice **B**.
...
Target: `P(A)=0.380000`, `u=0.629211`, choice **B**.
...
The run-commit effect gate used a strict floating-point `> 0` comparison. The stored mean is effectively zero, so round-off marked that effect-size gate PASS. Treat it substantively as zero; the preregistered inference gate failed and the overall STOP decision is unchanged.
...
The real provider received an empty structured context and only the rendered prompts. Registered frame labels in this report are experiment-side audit metadata reconstructed after each choice.
